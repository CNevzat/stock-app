...
// Avoid ResizeObserver/detached → _resize on null canvas (React mount/unmount, Strict Mode).
// Mosaic charts use explicit canvas width/height props instead of container-driven sizing.

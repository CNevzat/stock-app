...
public sealed record DeleteProductAttributeCommand : IRequest<DeleteProductAttributeCommandResponse>
{
    public int Id { get; init; }
}

public sealed record DeleteProductAttributeCommandResponse
{
    public int ProductAttributeId { get; set; }
}

internal sealed class DeleteProductAttributeCommandHandler : IRequestHandler<DeleteProductAttributeCommand, DeleteProductAttributeCommandResponse>
{

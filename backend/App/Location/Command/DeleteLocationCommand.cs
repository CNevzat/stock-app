...
public sealed record DeleteLocationCommand : IRequest<DeleteLocationCommandResponse>
{
    public int Id { get; init; }
}

public sealed record DeleteLocationCommandResponse
{
    public int LocationId { get; set; }
}

internal sealed class DeleteLocationCommandHandler : IRequestHandler<DeleteLocationCommand, DeleteLocationCommandResponse>
{

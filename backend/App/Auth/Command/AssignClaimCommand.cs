...
public sealed record AssignClaimCommand(string UserId, string ClaimType, string ClaimValue) : IRequest;

internal sealed class AssignClaimCommandHandler : IRequestHandler<AssignClaimCommand>
{

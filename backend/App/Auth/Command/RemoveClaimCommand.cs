...
public sealed record RemoveClaimCommand(string UserId, string ClaimType) : IRequest;

internal sealed class RemoveClaimCommandHandler : IRequestHandler<RemoveClaimCommand>
{

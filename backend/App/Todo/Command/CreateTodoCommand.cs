...
public sealed record CreateTodoCommand : IRequest<CreateTodoCommandResponse>
{
...
public sealed record CreateTodoCommandResponse(int Id);

internal sealed class CreateTodoCommandHandler : IRequestHandler<CreateTodoCommand, CreateTodoCommandResponse>
{

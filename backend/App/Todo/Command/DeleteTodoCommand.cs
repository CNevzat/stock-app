...
public sealed record DeleteTodoCommand(int Id, string UserId = "") : IRequest<DeleteTodoCommandResponse>;

public sealed record DeleteTodoCommandResponse(int Id);

internal sealed class DeleteTodoCommandHandler : IRequestHandler<DeleteTodoCommand, DeleteTodoCommandResponse>
{

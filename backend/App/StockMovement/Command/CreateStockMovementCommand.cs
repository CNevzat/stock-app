...
public sealed record CreateStockMovementCommand : IRequest<CreateStockMovementCommandResponse>
{
...
public sealed record CreateStockMovementCommandResponse(int Id);

internal sealed class CreateStockMovementCommandHandler : IRequestHandler<CreateStockMovementCommand, CreateStockMovementCommandResponse>
{
